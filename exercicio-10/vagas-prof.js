...
function exibirVaga() {
    ...
    const cadidatosEmTexto = vaga.candidatos.reduce(function (textoFinal, candidato) {
        return textoFinal + "\n - " + candidato
    }, "")
    ...
    alert(
        ...
        "\nCanditados incritos: " + candidatosEmTexto
    )
}
...
function inscreverCandidato() {
    ...
    function excluirVaga() {
        const indice = prompt("Informe o íncide da vaga que deseja excluir:")
        const vaga = vagas[indice]
